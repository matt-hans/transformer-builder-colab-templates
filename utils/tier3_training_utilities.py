...
def test_amp_speedup_benchmark(
    ...
    if memory_reduction >= 30:
        print(f"  ✅ Memory reduction good: {memory_reduction:.1f}% >= 30%")
    else:
        print(f"  ⚠️ Memory reduction modest: {memory_reduction:.1f}% < 30%")
    ...
    return {
        ...
        "requirements_met": {
            ...
            "memory_reduction_30pct": memory_reduction >= 30,
