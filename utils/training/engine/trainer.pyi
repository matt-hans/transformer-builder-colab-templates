...
class Trainer:
    ...
    def __init__(self, model: nn.Module, config: SimpleNamespace | Any, training_config: TrainingConfig, task_spec: TaskSpec | None = None, hooks: TrainingHooks | None = None) -> None: ...
